...
$doc->setGenerator('Filippone');
if (JRequest::getInt('Itemid') == 101 )
{
    $doc->addCustomTag('<link rel="canonical" href="https://www.filipponepropiedades.com"/> ');
}
?><!DOCTYPE html>
...
$doc->addCustomTag('<meta property="og:title" content="Filippone propiedades." />');
$doc->addCustomTag('<meta property="og:image" content="http://www.filipponepropiedades.com/images/filippone-propiedades-logo-800.jpg" />');
    ...
    <header id="header" class="header">            
        <nav class="navbar navbar-expand-md navbar-light container-menu-all">
            <a class="navbar-brand" href="./">
                <img class="logo-superior" src="/images/logo.jpg" alt="Filippone logo">
                <img class="logo-superior-min" src="/images/logo.jpg" alt="Filippone logo">
            </a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-4 col-topbar">                            
                            <div class="icon-facebook"><a target="_blank" href="https://www.facebook.com/Filippone-Propiedades" alt="Facebook"><span>facebook</span></a> </div>
                        </div>
...
-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
            		<div class="copyright">
                        <p>Filippone propiedades - 11 de Abril 573 - Bahía Blanca - Buenos Aires - Argentina</p>
                        <p>Todos los derechos Reservados Filipponepropiedades SRL | Bahía Blanca</p>
